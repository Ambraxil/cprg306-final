      ...
      {user && (
        <>
          ...
          <Link href="/landing/list-list">
            <button className="px-4 py-2 border-2 border-black rounded-xl hover:cursor-pointer bg-white hover:bg-gray-100 mt-4">
              Go to your Lists
            </button>
          </Link>
          ...
          <button
            ...
            className="px-4 py-2 border-2 border-black rounded-xl hover:cursor-pointer bg-white hover:bg-gray-100 mt-4"
          >
            Sign Out
          </button>
        </>
